...
if (Headlamp.isRunningAsApp()) {
  ...
  // BareMetal Test Environment — gated by REACT_APP_ENABLE_BAREMETAL_TEST_ENV env var.
  // To enable: set REACT_APP_ENABLE_BAREMETAL_TEST_ENV=true in your .env or shell before building.
  if (process.env.REACT_APP_ENABLE_BAREMETAL_TEST_ENV === 'true') {
    registerAddClusterProvider({
