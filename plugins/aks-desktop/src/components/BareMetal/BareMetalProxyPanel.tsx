    ...
    >
      ...
      <Typography variant="body2" sx={{ mb: 1 }} role="status" aria-live="polite">
        ...
        {proxyStatus === null ? (
          ...
          <>
            {proxyStatus.status.toUpperCase()}
      ...
      {proxyStatus?.debugLog && proxyStatus.debugLog.length > 0 && (
        <Box
          component="pre"
          sx={{
            mb: 1,
      ...
      <Box display="flex" gap={1} flexWrap="wrap">
        ...
        <Button
          ...
          disabled={proxyActionLoading || disabled || proxyStatus === null}
